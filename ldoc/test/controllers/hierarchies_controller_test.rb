...
class HierarchiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hierarchy" do
    assert_difference('Hierarchy.count') do
      post hierarchies_url, params: { hierarchy: { father: @hierarchy.father, item: @hierarchy.item, position: @hierarchy.position } }
    end
  ...
  test "should update hierarchy" do
    patch hierarchy_url(@hierarchy), params: { hierarchy: { father: @hierarchy.father, item: @hierarchy.item, position: @hierarchy.position } }
